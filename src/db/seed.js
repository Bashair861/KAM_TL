...
async function seedAccounts() {
  await upsert("accounts", [
    ...
    },
    {
      ...
      client_history:
        "Onboarded 2020. Compliance-heavy. Recent CTO change risks scope re-evaluation.",
      revenue: "$11.4B (FY24)",
      mrr_arr: null,
      is_startup: false,
...
async function seedActivities() {
  await upsert("activities", [
    ...
    },
    {
      ...
      status: "In Progress",
      rag: "G",
      expected_lift: "+0.5 relationship",
    },
    {
      id: "axiom-a2",
      account_id: "axiom",
    ...
    },
    {
      ...
      status: "Open",
      rag: "R",
      expected_lift: "+1.0 relationship",
    },
    {
      id: "vertex-a2",
      account_id: "vertex",
    ...
    },
    {
      ...
      status: "Open",
      rag: "A",
      expected_lift: "+0.7 relationship",
    },
    {
      id: "northwind-a1",
      account_id: "northwind",
      ...
      status: "Open",
      rag: "R",
      expected_lift: "+1.5 relationship",
    },
    {
      id: "northwind-a2",
      account_id: "northwind",
  ...
  await upsert("retention_growth", [
    {
      ...
      delivered: true,
      applicable: true,
      tracking_note: "Steady — 99.97% SLA YTD.",
    },
    {
      ...
      delivered: false,
      applicable: true,
      tracking_note: "Proposal sent, CTO reviewing.",
    },
    {
      ...
      delivered: false,
      applicable: true,
      tracking_note: "Discovery call scheduled.",
    },
    {
      ...
      delivered: false,
      applicable: false,
      tracking_note: "Client uses in-house Snowflake stack.",
    },
    {
    ...
    },
    {
      ...
      delivered: false,
      applicable: true,
      tracking_note: "Pilot starting next month.",
    },
    {
      id: "f2000001-0000-0000-0000-000000000004",
      account_id: "axiom",
      service: "Predictive ETA AI",
      offered: false,
      delivered: false,
      applicable: true,
      tracking_note: "White-space — pitch in QBR.",
    },
    {
      id: "f2000001-0000-0000-0000-000000000005",
      account_id: "axiom",
      service: "Driver HR module",
      offered: false,
      delivered: false,
      applicable: false,
      tracking_note: "Out of scope; handled internally.",
    },
    {
      ...
      delivered: true,
      applicable: true,
      tracking_note: "Slowed — Plant 7 rollout paused.",
    },
    {
      ...
      delivered: false,
      applicable: true,
      tracking_note: "Demo pending re-schedule.",
    },
    {
      ...
      delivered: false,
      applicable: true,
      tracking_note: "Future opportunity post-renewal.",
    },
    {
      id: "f4000001-0000-0000-0000-000000000001",
      account_id: "cloudpeak",
      service: "Realtime Sync Platform",
      offered: true,
      delivered: true,
      applicable: true,
      tracking_note: "Core dep — stable.",
    },
    {
      id: "f4000001-0000-0000-0000-000000000002",
      account_id: "cloudpeak",
      service: "Observability",
      offered: true,
      delivered: true,
      applicable: true,
      tracking_note: "Scaling with APAC region.",
    },
    {
      id: "f4000001-0000-0000-0000-000000000003",
      account_id: "cloudpeak",
      service: "AI Insights",
      offered: false,
      delivered: false,
      applicable: true,
      tracking_note: "Pitch in upcoming QBR.",
    },
    {
      id: "f4000001-0000-0000-0000-000000000004",
      account_id: "cloudpeak",
      service: "On-prem deployment",
      offered: false,
      delivered: false,
      applicable: false,
      tracking_note: "Not relevant; SaaS-only product.",
    },
    {
      ...
      delivered: true,
      applicable: true,
      tracking_note: "Stable.",
    },
    {
      id: "f5000001-0000-0000-0000-000000000002",
      account_id: "northwind",
      service: "Reg-Reporting",
      offered: true,
      delivered: true,
      applicable: true,
      tracking_note: "Quarterly cadence.",
    },
    {
      id: "f5000001-0000-0000-0000-000000000003",
      account_id: "northwind",
      service: "AI Co-pilot",
      offered: false,
      delivered: false,
      applicable: true,
      tracking_note: "Pilot proposed.",
    },
    {
      id: "f5000001-0000-0000-0000-000000000004",
      account_id: "northwind",
      service: "Retail mobile banking",
      offered: false,
      delivered: false,
      applicable: false,
      tracking_note: "Owned by separate vendor.",
    },
  ]);
}
// ─── education_log ───────────────────────────────────────────────────────────
...
async function seedEscalations() {
  ...
  await upsert("escalation_action_items", [
    {
      id: "ea000001-0000-0000-0000-000000000001",
      escalation_id: "esc-001",
      label: "Rollback deployment v4.2",
      done: false,
    },
    {
      id: "ea000001-0000-0000-0000-000000000002",
      escalation_id: "esc-001",
      label: "Notify CTO Jenkins (48h SLA call)",
      done: false,
    },
    {
      id: "ea000001-0000-0000-0000-000000000003",
      escalation_id: "esc-001",
      label: "Internal incident brief",
      done: true,
    },
    {
      id: "ea000002-0000-0000-0000-000000000001",
      escalation_id: "esc-002",
      label: "Engage on-call SRE lead",
      done: true,
    },
    {
      id: "ea000002-0000-0000-0000-000000000002",
      escalation_id: "esc-002",
      label: "Client update call (14:00 GMT)",
      done: false,
    },
    {
      id: "ea000002-0000-0000-0000-000000000003",
      escalation_id: "esc-002",
      label: "Draft post-mortem outline",
      done: false,
    },
    {
      id: "ea000003-0000-0000-0000-000000000001",
      escalation_id: "esc-003",
      label: "Prepare counter-proposal deck",
      done: false,
    },
    {
      id: "ea000003-0000-0000-0000-000000000002",
      escalation_id: "esc-003",
      label: "Loop in Legal",
      done: false,
    },
  ...
  await upsert("opportunities", [
    {
      ...
      potential: 120000,
      confidence: "High",
      next_step: "Draft 1-pager + scope by Friday",
    },
    {
      id: "op2",
      account_id: "starlight",
      ...
      potential: 80000,
      confidence: "Medium",
      next_step: "Pitch 6-week paid POC",
    },
    {
      id: "op3",
      account_id: "starlight",
      ...
      potential: 240000,
      confidence: "Medium",
      next_step: "Schedule exec brief with sponsor",
    },
    {
      id: "op4",
      account_id: "axiom",
      ...
      potential: 90000,
      confidence: "High",
      next_step: "Bundle into renewal package",
    },
    {
      id: "op5",
      account_id: "vertex",
      ...
      potential: 60000,
      confidence: "Medium",
      next_step: "Confirm scope with sponsor",
    },
  ]);
}
// ─── notifications ───────────────────────────────────────────────────────────
