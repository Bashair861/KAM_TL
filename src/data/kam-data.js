const baseHealth = (score, metrics) => ({ score, metrics });
export const accounts = [
  {
    ...
    description:
      "Distributed cloud platform serving fintech and logistics workloads across NA and EMEA.",
    businessInfo:
      "B2B SaaS providing managed Kubernetes, edge compute, and observability to mid-market fintech.",
    clientHistory:
      "Onboarded Q2 2021. Expanded from 2 to 18 engineers. Renewed twice; survived one P0 escalation in 2023.",
    stakeholders: [
      {
        name: "Sarah Jenkins",
        role: "CTO",
    ...
    mainBusinessFlow:
      "Customer → onboarding API → managed cluster provisioning → observability dashboards → billing.",
    ...
    activities: [
      {
        id: "a1",
        area: "Relationship",
        title: "CEO-to-CEO sync in NYC",
        owner: "Julian Drake",
        due: "In 12d",
        status: "Open",
        rag: "A",
        expectedLift: "+4 relationship",
      },
      {
        id: "a2",
        area: "Project",
        title: "Defect-rate war-room",
        owner: "Maya Lin",
        due: "In 5d",
        status: "In Progress",
        rag: "A",
        expectedLift: "+1.2 project",
      },
      {
        id: "a3",
        area: "Financial",
        title: "Negotiate 8% price hike on renewal",
        owner: "Julian Drake",
        due: "60d",
        status: "Open",
        rag: "G",
        expectedLift: "+$190k ARR",
      },
      {
        id: "a4",
        area: "Resource",
        title: "Add backup SRE for cluster",
        owner: "Maya Lin",
        due: "30d",
        status: "Open",
        rag: "R",
        expectedLift: "+1.5 resource",
      },
    ],
    retentionGrowth: [
      {
        ...
        delivered: true,
        applicable: true,
        trackingNote: "Steady — 99.97% SLA YTD.",
      },
      {
        service: "Cloud Managed Security",
        offered: true,
        delivered: false,
        applicable: true,
        trackingNote: "Proposal sent, CTO reviewing.",
      },
      {
        service: "Edge Observability",
        offered: false,
        delivered: false,
        applicable: true,
        trackingNote: "Discovery call scheduled.",
      },
      {
        ...
        delivered: false,
        applicable: false,
        trackingNote: "Client uses in-house Snowflake stack.",
      },
    ],
    educationLog: [
      {
        date: "OCT 12, 2024",
        topic: "Digital Infrastructure Roadmap",
        approach: "Workshop + 3-year capacity model",
        outcome: "Aligned on EMEA expansion phase 1",
      },
      {
        date: "SEP 05, 2024",
        topic: "Cloud Migration Efficiency Audit",
        approach: "Data-driven audit, then exec readout",
        outcome: "Identified $310k/yr saving",
      },
    ],
  },
  {
    ...
    businessInfo:
      "Global freight + last-mile delivery. Modernizing dispatch & telemetry on our platform.",
    ...
    activities: [
      {
        ...
        status: "In Progress",
        rag: "G",
        expectedLift: "+0.5 relationship",
      },
      {
        id: "a2",
        area: "Project",
        title: "Resolve DB indexing post-mortem",
        owner: "Maya Lin",
        due: "Today",
        status: "In Progress",
        rag: "R",
        expectedLift: "Recover trust",
      },
      {
        id: "a3",
        area: "Profit",
        title: "Pitch EMEA fulfillment node",
        owner: "Julian Drake",
        due: "30d",
        status: "Open",
        rag: "G",
        expectedLift: "+$1.2M ARR",
      },
    ],
    retentionGrowth: [
      {
        ...
        delivered: true,
        applicable: true,
        trackingNote: "+14% accuracy YoY.",
      },
      {
        service: "Driver Mobile App",
        offered: true,
        delivered: true,
        applicable: true,
        trackingNote: "Adoption 92%.",
      },
      {
        ...
        delivered: false,
        applicable: true,
        trackingNote: "Pilot starting next month.",
      },
      {
        service: "Predictive ETA AI",
        offered: false,
        delivered: false,
        applicable: true,
        trackingNote: "White-space — pitch in QBR.",
      },
      {
        service: "Driver HR module",
        offered: false,
        delivered: false,
        applicable: false,
        trackingNote: "Out of scope; handled internally.",
      },
    ],
    educationLog: [
      {
        date: "AUG 21, 2024",
        topic: "Security Posture Review",
        approach: "External pen-test + workshop",
        outcome: "Closed 14 of 17 findings in 60 days",
      },
    ],
  },
  {
    ...
    businessInfo:
      "Industrial manufacturing; modernizing SCADA + factory telemetry across 22 plants.",
    ...
    activities: [
      {
        id: "a1",
        area: "Relationship",
        title: "Schedule director-level reset call",
        owner: "Julian Drake",
        due: "48h",
        status: "Open",
        rag: "R",
      ...
      },
      {
        id: "a2",
        area: "Project",
        title: "RCA review with Plant Ops",
        owner: "Maya Lin",
        due: "5d",
        status: "Open",
        rag: "R",
        expectedLift: "+0.8 project",
      },
      {
        id: "a3",
        area: "Resource",
        title: "Onboard backup SCADA engineer",
        owner: "Hiring",
        due: "21d",
        status: "Open",
        rag: "R",
    ...
    retentionGrowth: [
      {
        service: "SCADA Modernization",
        offered: true,
        delivered: true,
        applicable: true,
        trackingNote: "Slowed — Plant 7 rollout paused.",
      },
      {
        ...
        delivered: false,
        applicable: true,
        trackingNote: "Demo pending re-schedule.",
      },
      {
        service: "Worker Safety AI",
        offered: false,
        delivered: false,
        applicable: true,
        trackingNote: "Future opportunity post-renewal.",
      },
    ],
    educationLog: [
      {
        date: "JUN 10, 2024",
        topic: "SCADA Best Practices",
        approach: "On-site workshop",
        outcome: "Buy-in from 2 of 5 plant managers",
      },
    ],
  },
  {
    ...
    mainBusinessFlow:
      "Sign-up → workspace provisioning → realtime sync → billing → enterprise SSO.",
    ...
    activities: [
      {
        id: "a1",
        area: "Profit",
        title: "AI feature pack proposal",
        owner: "Julian Drake",
        due: "21d",
        status: "Open",
        rag: "G",
        expectedLift: "+$300k ARR",
      },
      {
        id: "a2",
        area: "Relationship",
        title: "Re-engage CEO Anika monthly",
        owner: "Julian Drake",
        due: "ongoing",
        status: "Open",
        rag: "A",
        expectedLift: "+0.7 relationship",
      },
    ],
    retentionGrowth: [
      {
        service: "Realtime Sync Platform",
        offered: true,
        delivered: true,
        applicable: true,
        trackingNote: "Core dep — stable.",
      },
      {
        ...
        delivered: true,
        applicable: true,
        trackingNote: "Scaling with APAC region.",
      },
      {
        service: "AI Insights",
        offered: false,
        delivered: false,
        applicable: true,
        trackingNote: "Pitch in upcoming QBR.",
      },
      {
        service: "On-prem deployment",
        offered: false,
        delivered: false,
        applicable: false,
        trackingNote: "Not relevant; SaaS-only product.",
      },
    ],
    educationLog: [
      {
        date: "AUG 02, 2024",
        topic: "APAC Expansion Workshop",
        approach: "Strategy sprint",
        outcome: "Roadmap agreed for SG + Tokyo POPs",
      },
    ],
  },
  {
    ...
    businessInfo:
      "European retail + commercial bank. Regulated workloads, strict change management.",
    ...
    activities: [
      {
        id: "a1",
        area: "Relationship",
        title: "Exec intro to new CTO",
        owner: "Julian Drake",
        due: "10d",
        status: "Open",
        rag: "R",
        expectedLift: "+1.5 relationship",
      },
      {
        id: "a2",
        area: "Profit",
        title: "Reg-reporting AI pilot",
        owner: "Maya Lin",
        due: "45d",
        status: "Open",
        rag: "G",
        expectedLift: "+$220k ARR",
      },
    ],
    retentionGrowth: [
      {
      ...
      {
        service: "Reg-Reporting",
        offered: true,
        delivered: true,
        applicable: true,
        trackingNote: "Quarterly cadence.",
      },
      {
        service: "AI Co-pilot",
        offered: false,
        delivered: false,
        applicable: true,
        trackingNote: "Pilot proposed.",
      },
      {
        service: "Retail mobile banking",
        offered: false,
        delivered: false,
        applicable: false,
        trackingNote: "Owned by separate vendor.",
      },
    ],
    educationLog: [
      {
        date: "MAY 16, 2024",
        topic: "Reg-Reporting Modernization",
        approach: "Whitepaper + exec workshop",
        outcome: "Pilot scoped for Q3",
      },
    ],
  },
];
...
export const escalations = [
  {
    ...
    description:
      "Customer reports degraded dashboard responsiveness during peak hours. Performance budget exceeded on three endpoints.",
    actionItems: [
  ...
  },
  {
    ...
    description:
      "Primary stakeholder at Axiom requesting a 1:1 call within 48 hours. ERP sync delayed.",
    actionItems: [
  ...
  },
  {
    ...
    description:
      "Director of IT pushing for SLA changes that cannot be met under current pricing. Recommend tiered package.",
    actionItems: [
...
export const recommendations = [
  {
    id: "r1",
    accountId: "starlight",
    title: "Schedule QBR Transition",
    body: "Shift from tactical to strategic review to address health score drop.",
    level: "accent",
    impact: "+6 score",
  },
  {
    id: "r2",
    accountId: "starlight",
    title: "Exec Sponsor Re-connect",
    body: "Sarah Jenkins (CTO) has been quiet for 14 days. Suggest brief sync.",
    level: "warn",
    impact: "+3 score",
  },
  {
    id: "r3",
    accountId: "axiom",
    title: "Propose EMEA Fulfillment Node",
    body: "Whitespace opportunity to expand into European logistics nodes.",
    level: "accent",
    impact: "+$120k ARR",
  },
];
export const advisoryHistory = [
  {
    date: "OCT 12, 2024",
    title: "Digital Infrastructure Roadmap Presentation",
    accountId: "starlight",
  },
  {
    date: "SEP 05, 2024",
    title: "Efficiency Audit Report: Cloud Migration",
    accountId: "starlight",
  },
...
export const notifications = [
  {
    id: "n1",
    title: "Action: 48h meeting with Axiom",
    body: "Marcus Hale (VP Eng) requested a sync. SLA 28h.",
    accountId: "axiom",
    time: "12m ago",
    type: "action",
    read: false,
  ...
  {
    id: "n2",
    title: "P1 Escalation opened — Starlight",
    body: "API latency on West-2 cluster.",
    accountId: "starlight",
    time: "1h ago",
    type: "alert",
    read: false,
  ...
  {
    id: "n3",
    title: "Renewal in 14 days — Axiom",
    body: "Prepare auto-renew + 8% price hike doc.",
    accountId: "axiom",
    time: "Today 09:00",
    type: "action",
    read: false,
  ...
  {
    id: "n4",
    title: "New CTO joined Northwind",
    body: "Plan an exec intro within 10 days.",
    accountId: "northwind",
    time: "Yesterday",
    type: "info",
    read: true,
  ...
  {
    id: "n5",
    title: "Vertex risk score dropped to 3.8",
    body: "Competitor activity flag triggered.",
    accountId: "vertex",
    time: "Yesterday",
    type: "alert",
    read: true,
...
export const portfolioNews = [
  {
    id: "nw1",
    type: "new_account",
    title: "New key account onboarded — Helios Robotics",
    body: "Added to portfolio under Head of KAM oversight. KYC due in 7 days.",
    time: "2h ago",
  },
  {
    id: "nw2",
    type: "management_change",
    title: "Northwind appointed new CTO",
    body: "Priya Anand replaces previous CTO. Plan an exec intro within 10 days.",
    accountId: "northwind",
    time: "Yesterday",
  },
  {
    id: "nw3",
    type: "renewal",
    title: "Axiom renewal window opens",
    body: "14 days to renewal — prepare auto-renew + 8% price hike memo.",
    accountId: "axiom",
    time: "Today 09:00",
  },
  {
    ...
    type: "risk",
    title: "Vertex risk score dropped to 3.8",
    body: "Competitor activity flag triggered — review white-space pitch.",
    accountId: "vertex",
    time: "Yesterday",
  },
  {
    id: "nw5",
    type: "milestone",
    title: "Starlight crossed $1.2M ARR",
    body: "Expansion deal closed by KAM team. CSAT bumped to 8.6.",
    accountId: "starlight",
    time: "2 days ago",
  },
];
export const openActionItems = [
  {
    id: "ai1",
    title: "Client update call with Marcus Hale",
    accountId: "axiom",
    due: "Today 14:00",
    priority: "P1",
    source: "Escalation",
  ...
  {
    id: "ai2",
    title: "Draft post-mortem outline for DB indexing",
    accountId: "axiom",
    due: "Tomorrow",
    priority: "P1",
    source: "Escalation",
  ...
  {
    id: "ai3",
    title: "Prepare counter-proposal deck for Vertex",
    accountId: "vertex",
    due: "In 2 days",
    priority: "P2",
    source: "Meeting",
  ...
  {
    id: "ai4",
    title: "Schedule QBR with Starlight CTO",
    accountId: "starlight",
    due: "This week",
    priority: "P2",
    source: "QBR",
  ...
  {
    id: "ai5",
    title: "Prepare auto-renew + price-hike memo (Axiom)",
    accountId: "axiom",
    due: "In 5 days",
    priority: "P2",
    source: "Renewal",
...
export const calendarSources = [
  ...
  {
    id: "gm-shared",
    label: "Renewals Inbox",
    email: "renewals@aether.io",
    provider: "Gmail",
    color: "bg-warn",
    connected: true,
  },
...
export const globalCalendar = [
  {
    id: "ev1",
    title: "Axiom — Post-mortem call with Marcus Hale",
    start: "Today 14:00",
    durationMin: 45,
    source: "ol-julian",
    type: "call",
  ...
  {
    id: "ev2",
    title: "Starlight QBR prep (internal)",
    start: "Today 16:30",
    durationMin: 30,
    source: "gw-aether",
    type: "meeting",
  ...
  {
    id: "ev3",
    title: "Renewal review — Vertex auto-renew clauses",
  ...
  {
    id: "ev4",
    title: "Escalation triage — P1 backlog walk-through",
    start: "Tomorrow 11:00",
    durationMin: 30,
    source: "gm-escal",
    type: "task",
    attendees: 5,
  ...
  {
    id: "ev5",
    title: "Starlight CTO sync — roadmap alignment",
    start: "Wed 10:30",
    durationMin: 60,
    source: "ol-julian",
    type: "meeting",
  ...
  {
    id: "ev6",
    title: "Send price-hike memo (Axiom)",
    start: "Wed 17:00",
    durationMin: 15,
    source: "gw-aether",
    type: "task",
  ...
  {
    id: "ev7",
    title: "Aether weekly KAM standup",
    start: "Thu 09:00",
    durationMin: 30,
    source: "gw-aether",
    type: "meeting",
  ...
  {
    id: "ev8",
    title: "Vertex — exec sponsor lunch",
    start: "Fri 12:30",
    durationMin: 90,
    source: "ol-julian",
    type: "meeting",
...
export const opportunities = [
  {
    id: "op1",
    accountId: "starlight",
    title: "EMEA fulfillment node — confirmed budget exists",
    source: "Discovery call · 09 May",
    signalDate: "09 May",
    potential: 120000,
    confidence: "High",
    nextStep: "Draft 1-pager + scope by Friday",
  },
  {
    id: "op2",
    accountId: "starlight",
    title: "AI co-pilot pilot for ops team (heard on call)",
    source: "QBR transcript",
    signalDate: "18 May",
    potential: 80000,
    confidence: "Medium",
    nextStep: "Pitch 6-week paid POC",
  },
  {
    id: "op3",
    accountId: "starlight",
    title: "Compliance automation — competitor contract expiring",
    source: "Public 10-K filing",
    signalDate: "12 May",
    potential: 240000,
    confidence: "Medium",
    nextStep: "Schedule exec brief with sponsor",
  },
  {
    id: "op4",
    accountId: "axiom",
    title: "Disaster-recovery retainer after the P1 incident",
    source: "Escalation call",
    signalDate: "13 May",
    potential: 90000,
    confidence: "High",
    nextStep: "Bundle into renewal package",
  },
  {
    id: "op5",
    accountId: "vertex",
    title: "Data-residency add-on (EU)",
    source: "Procurement RFI",
    signalDate: "07 May",
    potential: 60000,
    confidence: "Medium",
    nextStep: "Confirm scope with sponsor",
  },
];
export function getOpportunities(accountId) {
  return opportunities.filter((o) => o.accountId === accountId);
}
export const industryArticles = [
  {
    id: "ia1",
    title: "How Agentic AI Is Reshaping Key Account Management in 2026",
    source: "Harvard Business Review",
    date: "May 2026",
    summary:
      "Agentic AI assistants are now embedded in CRM workflows, surfacing churn signals and white-space opportunities 3x faster than manual review.",
    tags: ["Agentic AI", "KAM", "CRM"],
  },
  {
    id: "ia2",
    title: "From Dashboards to Decisions: The Rise of LLM-Powered Account 360",
    source: "McKinsey Digital",
    date: "Apr 2026",
    summary:
      "Enterprises adopting LLM-summarised Account 360 views report 22% lift in stakeholder coverage and 14% shorter renewal cycles.",
    tags: ["LLM", "Account 360", "Renewals"],
  },
  {
    id: "ia3",
    title: "Vector Search Is Eating Customer Support Backlogs",
    source: "a16z Enterprise",
    date: "Mar 2026",
    summary:
      "Embedding-based search over Jira + meeting notes lets KAMs auto-extract action items, cutting follow-up time by 40%.",
    tags: ["Vector Search", "Jira", "Support"],
  },
  {
    id: "ia4",
    title: "The 48-Hour Rule: Closed-Loop Escalation Playbooks That Work",
    source: "Gainsight Pulse",
    date: "Mar 2026",
    summary:
      "Top-quartile CSMs resolve P1 escalations under 48h by combining live SLA timers, automated RCAs, and exec-sponsored callbacks.",
    tags: ["Escalation", "SLA", "RCA"],
  },
  {
    id: "ia5",
    title: "WhatsApp Business + AI: A New Default for Client Touchpoints",
    source: "TechCrunch",
    date: "Feb 2026",
    summary:
      "B2B teams are replacing low-engagement email nudges with AI-drafted WhatsApp messages — open rates above 90% in pilot accounts.",
    tags: ["WhatsApp", "AI", "Engagement"],
  },
  {
    id: "ia6",
    title: "Contract Intelligence: Spotting Auto-Renew Traps with AI",
    source: "Gartner",
    date: "Feb 2026",
    summary:
      "AI contract analyzers flag missing auto-renew, non-terminator and price-hike clauses in seconds — material risk reduced 35%.",
    tags: ["Contracts", "AI", "Compliance"],
  },
];
...
export function canEdit(accountId) {
