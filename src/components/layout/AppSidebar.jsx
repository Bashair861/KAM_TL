        ...
        <div className="mx-3 mb-3 bg-white/5 border border-white/10 rounded-lg overflow-hidden">
          ...
          <div className="max-h-72 overflow-y-auto divide-y divide-white/5">
            {notifs.map((n) => {
              ...
              const dot =
                n.type === "alert" ? "bg-crit" : n.type === "action" ? "bg-warn" : "bg-accent";
              return (
        ...
        {items.map((item) => {
          ...
          return (
            ...
            >
              ...
              {item.badge ? (
                <span className="bg-crit px-1.5 py-0.5 rounded text-[10px] text-white font-bold">
                  {item.badge}
                </span>
              ) : null}
            </Link>
        ...
        <div className="flex items-center gap-3 px-3 py-1">
          ...
          <div className="text-xs min-w-0 flex-1">
            ...
            <div className="flex items-center gap-1 text-slate-500">
              ...
              <span
                className={`ml-1 px-1 py-px rounded text-[9px] font-bold uppercase ${perms.write ? "bg-success/20 text-success" : "bg-muted/20 text-slate-300"}`}
              >
                {perms.write ? "RW" : "RO"}
              </span>
            </div>
