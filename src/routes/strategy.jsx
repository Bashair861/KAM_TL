...
function Lane({ title, subtitle, accent, items }) {
  return (
    <div className="bg-card border rounded-xl overflow-hidden">
      ...
      <div className="divide-y">
        {items.map((i) => (
          <div
            key={i.name}
            className="px-6 py-4 flex items-center justify-between hover:bg-muted/40 transition-colors"
          >
            <div>
